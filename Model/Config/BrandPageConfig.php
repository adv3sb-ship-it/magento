...
class BrandPageConfig extends BaseConfig
{
    ...
    const BOTTOM_OF_THE_PAGE        = 'Bottom of the page';
    const UNDER_PRODUCT_LIST        = 'Under product list';
    const FROM_DEFAULT              = 'From default (Admin)';
    const DISABLED_SEO_POSITION     = 'Disabled';
    const BOTTOM_SEO_POSITION       = 'bottom_page';
    const PRODUCT_LIST_SEO_POSITION = 'under_product_list';
    const FROM_DEFAULT_POSITION     = 'from_default';
    const DISABLED_POSITION         = 'disabled_position';
