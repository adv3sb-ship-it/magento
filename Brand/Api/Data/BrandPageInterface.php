...
interface BrandPageInterface
{
    ...
    const SEO_POSITION            = 'seo_position';
    const ROBOTS                  = 'robots';
    ...
    const DISABLE_DEFAULT_INVERSE = 'disable_default_inverse';
    ...
    public function setSeoDescription(string $value): self;

    public function getSeoPosition(): string;

    public function setSeoPosition(string $value): self;
