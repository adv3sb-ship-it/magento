...
/**
 * @see \Magento\Catalog\Ui\DataProvider\Product\Form\ProductDataProvider
 */
class AddAttachmentTabToProductEditPlugin
{
    ...
    public function afterGetData(object $subject, array $result): array
    {
        ...
        $result    = $this->attachmentModifier->modifyData($result, LinkInterface::ENTITY_TYPE_PRODUCT, $productId);
