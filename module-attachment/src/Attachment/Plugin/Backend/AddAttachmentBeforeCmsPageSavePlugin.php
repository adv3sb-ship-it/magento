...
/**
 * @see \Magento\Cms\Controller\Adminhtml\Page\Save::execute()
 */
class AddAttachmentBeforeCmsPageSavePlugin
{
    ...
    public function beforeExecute(\Magento\Cms\Controller\Adminhtml\Page\Save $subject)
    {
        ...
        if (!$data || !array_key_exists('page_id', $data)) {
            return;
        }
        ...
        $this->attachmentService->saveForEntity(LinkInterface::ENTITY_TYPE_CMS_PAGE, $pageId, $attachmentsData);
    }
