...
{
    /**
     * @var $_paymentCms \Stagem\KeyCrm\Model\Config\Backend\PaymentCms
     */
    protected $_paymentCms;

    /**
     * @var $_paymentCrm \Stagem\KeyCrm\Model\Config\Backend\PaymentCrm
     */
    ...
    protected function _getPaymentCmsRenderer()
    {
        if (!$this->_paymentCms) {
            $this->_paymentCms = $this->getLayout()->createBlock(
                '\Stagem\KeyCrm\Model\Config\Backend\PaymentCms',
                '',
    ...
    protected function _getPaymentCrmRenderer()
    {
        if (!$this->_paymentCrm) {
            $this->_paymentCrm = $this->getLayout()->createBlock(
                '\Stagem\KeyCrm\Model\Config\Backend\PaymentCrm',
                '',
                ['data' => ['is_render_to_js_template' => true]]
            );
        }
